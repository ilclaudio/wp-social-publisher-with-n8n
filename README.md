...
DOC/          # English setup guides and technical notes
DOC_IT/       # Italian setup guides, notes, and drafted articles
config/       # local config templates and project support files
